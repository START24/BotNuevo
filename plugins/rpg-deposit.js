let handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  const ctxOk = global.rcanalr || { contextInfo: { externalAdReply: { title: '✅ Depósito', body: 'Oriax - Lm IA', thumbnailUrl: 'https://qu.ax/QGAVS.jpg', sourceUrl: global.canalOficial || '' }}}
