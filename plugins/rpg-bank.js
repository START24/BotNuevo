let handler = async (m, { conn, usedPrefix }) => {
  ...
  const ctxOk = global.rcanalr || { contextInfo: { externalAdReply: { title: '✅ Balance', body: 'Oriax - Lm IA', thumbnailUrl: 'https://qu.ax/QGAVS.jpg', sourceUrl: global.canalOficial || '' }}}
  ...
  const texto = `🍙💰 *Oriax - Lm - Balance Económico* 📚✨
