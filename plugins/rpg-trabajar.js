let handler = async (m, { conn, args, usedPrefix, command, isAdmin, isBotAdmin, participants }) => {
  const ctxErr = global.rcanalx || { contextInfo: { externalAdReply: { title: '❌ Error', body: 'Oriax - Lm IA', thumbnailUrl: 'https://qu.ax/FtdSt.jpg', sourceUrl: global.canalOficial || '' }}}
  const ctxWarn = global.rcanalw || { contextInfo: { externalAdReply: { title: '⚠️ Advertencia', body: 'Oriax - Lm IA', thumbnailUrl: 'https://qu.ax/FtdSt.jpg', sourceUrl: global.canalOficial || '' }}}
  const ctxOk = global.rcanalr || { contextInfo: { externalAdReply: { title: '✅ Éxito', body: 'Oriax - Lm IA', thumbnailUrl: 'https://qu.ax/FtdSt.jpg', sourceUrl: global.canalOficial || '' }}}
