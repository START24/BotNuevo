async function handler(m, { conn, args, usedPrefix, command }) {
  ...
  const ctxOk = global.rcanalr || { contextInfo: { externalAdReply: { title: '✅ Transferencia', body: 'Oriax - Lm IA', thumbnailUrl: 'https://qu.ax/QGAVS.jpg', sourceUrl: global.canalOficial || '' }}}
  ...
  await conn.reply(m.chat,
    `🍙💰 *Oriax - Lm - Transferencia Exitosa* 📚✨\n\n` +
    ...
    `🍱✨ "¡Gracias por usar el sistema bancario de Oriax - Lm!"`,
    m, 
    { ...ctxOk, mentions: [who] }
  )
